  ...
  renderSky: function(
    ...
    for(var i in starsdata) {
      ...
      if (d.length < 6) // hd
        ...
        var ra = d[0], dec = d[1], mag = [6], hd = d[5], label = d[7];
      ...
      // star size
      //if (( mag < 1 )&&(mag>0)) size = 200;
      //else if (( mag < 2 )&&(mag>1)) size = 180;
      else if ( mag < 3 ) size = 40;
      else if (( mag < 4 )&&(mag>3)) size = 30;
      else if (( mag < 5 )&&(mag>4)) size = 20;
      else if (( mag < 6 )&&(mag>5)) size = 15;
      else if (( mag < 7 )&&(mag>6)) size = 10;
      else size = 5;
